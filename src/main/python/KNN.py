...
plt.ylabel("")
plt.grid(ls='dotted')
plt.savefig('knn.class.svg', bbox_inches='tight', pad_inches=0.1)
plt.savefig('knn.class.eps', bbox_inches='tight', pad_inches=0.1)
os.remove('class.dat')
os.remove('data0.dat')
os.remove('data1.dat')
os.remove('data2.dat')
webbrowser.open('file://{}'.format(os.path.realpath('knn.class.svg')))
